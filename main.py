...
fh_1 = logging.FileHandler(basicFunc.getHerePath() + "/log/info.log", mode="w", encoding="utf-8")
fh_1.setLevel(logging.INFO)
fh_1.setFormatter(formatter)
logger.addHandler(fh_1)

fh_2 = logging.FileHandler(basicFunc.getHerePath() + "/log/debug.log", mode="w", encoding="utf-8")
