...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.ToolButton_Glossary = ToolButton(Form)
        self.ToolButton_Glossary.setObjectName(u"ToolButton_Glossary")

        self.horizontalLayout.addWidget(self.ToolButton_Glossary)
...
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.ToolButton_Glossary.setToolTip(QCoreApplication.translate("Form", u"<html><head/><body><p>\u67e5\u770b\u672f\u8bed\u8868\uff0c\u6216\u7f16\u8f91\u672f\u8bed\u3002</p><p>\u672f\u8bed\u8868\u4e2d\u7684\u8bcd\u6c47\u4f1a\u5728\u5de6\u4fa7\u539f\u6587\u4e2d\u9ad8\u4eae\u663e\u793a\uff1b\u5728\u8c03\u7528 API \u65f6\uff0c\u5982\u5bf9\u5e94 API \u652f\u6301\uff0c\u672f\u8bed\u8868\u4e2d\u7684\u8bcd\u6c47\u4e5f\u4e0d\u4f1a\u88ab\u7ffb\u8bd1\uff0c\u6216\u5c06\u7ffb\u8bd1\u4e3a\u6807\u51c6\u8bd1\u6587\u3002</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
...
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.PrimarySplitPushButton_API.setToolTip(QCoreApplication.translate("Form", u"\u5f53\u524d\u7684\u9ed8\u8ba4 API \u4e3a\u300c\u767e\u5ea6\u901a\u7528\u6587\u672c\u7ffb\u8bd1API\u300d", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.PushButton_EditAPIConfig.setToolTip(QCoreApplication.translate("Form", u"<html><head/><body><p>\u914d\u7f6e API \u4e4b\u540e\u624d\u80fd\u8c03\u7528 API \u5e76\u7ffb\u8bd1\u3002</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
